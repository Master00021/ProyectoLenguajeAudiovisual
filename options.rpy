...
define config.name = _("Proyecto de Lenguaje Audiovisual")
...
define build.name = "ProyectodeLenguajeAudiovisual"
...
define config.save_directory = "ProyectodeLenguajeAudiovisual-1687955339"
